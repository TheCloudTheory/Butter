...
class butter {
    ...
    renderResourceSelector() {
        ...
        http_1.default.get(`${config_1.default.GetContentUrl}/${this.selectedServiceId}/${this.selectedVersion}`, config_1.default.GetContentKey).then((_) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
class config {
    static get GetMapUrl() {
        return 'https://butter-prod-euw-functionapp.azurewebsites.net/api/GetMap';
    }
    static get GetMapKey() {
        return 'oQ0eFJ8snS4jldja7k1YyjBH09cuKrY3p5LBa4awhD/Wve22blAywg==';
    }
    static get GetContentUrl() {
        return 'https://butter-prod-euw-functionapp.azurewebsites.net/api/GetContent';
    }
    static get GetContentKey() {
        return 'H7lZjbEzw4Uhzc0d4HjaxwSRP46/oWMMKr8NljsWqoTp6Q03a5hIYw==';
    }
}
...
class http {
    ...
    static getRequest(url, isJson, key) {
